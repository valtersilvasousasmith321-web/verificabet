// ARQUIVO: cards.js - COMPONENTES VISUAIS ISOLADOS
window.CARD_TEMPLATES = {
    verde: function(p) {
        return `<div class="card card-verde" style="background:#1e2b24;border:1px solid #00ff88;padding:20px;border-radius:8px;margin-top:20px;color:#fff;">
            ...
            <div style="background:rgba(255,255,255,0.05);padding:10px;border-radius:6px;margin:12px 0;font-size:13px;border-left:3px solid #888;">
            ...
            <div style="background:rgba(0,255,136,0.03);border:1px solid rgba(0,255,136,0.15);padding:12px;border-radius:6px;margin:12px 0;">
            ...
            <div style="background:rgba(255,165,0,0.05);border:1px solid rgba(255,165,0,0.2);padding:12px;border-radius:6px;margin:12px 0;font-size:13px;color:#ffa500;line-height:1.4;">
                <p style="margin:0;">${p.alerta}</p>
            </div>
            <a href="${p.linkAfiliado}" target="_blank" rel="noopener noreferrer" style="display:block;text-align:center;background:#00ff88;color:#121212;padding:12px;border-radius:6px;text-decoration:none;font-weight:bold;margin-top:15px;box-shadow:0 4px 10px rgba(0,255,136,0.2);">Acessar Plataforma Oficial (Link Seguro)</a>
        </div>`;
    },
    vermelho: function(pirata) {
        return `<div class="card card-vermelho" style="background:#3a1e1e;border:1px solid #ff3333;padding:20px;border-radius:8px;margin-top:20px;color:#fff;">
            ...
            <div style="background:rgba(255,51,51,0.1);padding:12px;border-radius:6px;border-left:4px solid #ff3333;margin-top:12px;font-size:13px;line-height:1.4;"><strong>Risco Operacional:</strong> ${pirata.risco}</div>
        </div>`;
    },
    amarelo: function() {
        return `<div class="card card-amarelo" style="background:#2b2b1e;border:1px solid #ffcc00;padding:20px;border-radius:8px;margin-top:20px;color:#fff;">
            ...
            <p style="background:rgba(255,204,0,0.1);padding:10px;border-radius:4px;border-left:4px solid #ffcc00;font-size:13px;margin-top:12px;"><strong>Recomendação de Segurança:</strong> Se o endereço deste jogo não utilizar a terminação oficial e obrigatória <strong>.bet.br</strong>, evite inserir dados ou realizar aportes financeiros.</p>
        </div>`;
    }
};